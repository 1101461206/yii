...
<div class="user-backend-search">
    ...
    <div class="box box-solid">
        ...
        <div class="box-body ">
            ...
            <?php echo $form->field($searchModel, 'article_author') ?>

            <?php echo $form->field($searchModel, 'status')->dropDownList(['' => '请选择', '1' => '开启', '0' => '关闭']) ?>

            <?= $form->field($searchModel, 'article_category')->dropdownList(\yii\helpers\ArrayHelper::map($type, 'tid', 'name'), ['prompt' => '请选择']) ?>
