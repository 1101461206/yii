...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $city = array(
        ...
        'Kungota', 'Kuzma', 'Laško', 'Lenart', 'Lendava', 'Litija', 'Ljubljana', 'Ljubno', 'Ljutomer', 'LogForm - Dragomer', 'Logatec',
    ...
    protected static $street = array(
        ...
        'Brdo', 'Dobrava', 'Draga', 'Javorje', 'Kal', 'Laze', 'LogForm', 'Planina', 'Podkraj', 'Selce', 'Trnovec', 'Bistrica', 'Gorenja vas',
